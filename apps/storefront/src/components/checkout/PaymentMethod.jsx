    ...
    <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="px-5 pb-5">
        <button
          ...
          className={`relative flex w-full cursor-pointer items-center gap-3 rounded-lg border px-4 py-3.5 text-left transition ${isSelected
        ...
        >
          ...
          {isSelected && (
            <span className="ml-auto flex h-5 w-5 items-center justify-center rounded-full text-white" style={{ backgroundColor: "#76B432" }}>
