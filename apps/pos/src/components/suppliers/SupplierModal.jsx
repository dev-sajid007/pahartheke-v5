      ...
      <div className="relative w-full max-w-lg scale-100 rounded-2xl bg-card p-6 opacity-100 shadow-xl transition-all sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-5">
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div>
              <label className="mb-1.5 block text-sm font-medium text-sidebar-foreground">Contact Person *</label>
              <input
                type="text"
                name="name"
                value={formData.name}
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div>
              <label className="mb-1.5 block text-sm font-medium text-sidebar-foreground">Company Name</label>
              <input
                type="text"
                name="companyName"
          ...
          <div className="flex items-center gap-2 pt-2">
            ...
            />
            <label htmlFor="supplier-status" className="text-sm font-medium text-foreground">
              Active Status
            </label>
          </div>
